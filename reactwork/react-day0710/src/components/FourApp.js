                ...
                <tbody>
                    ...
                    <tr>
                        <td colSpan={2} align="center">
                            <Button variant="contained" color="error" onClick={resultButtonEvent}>결과출력하기</Button>
                        </td>
                    </tr>
                    <tr style={{height:'100px'}}>
                        <td style={{backgroundColor:'#ffc' , fontSize:'16px', whiteSpace:'pre-line' }} colSpan={2}>{result}</td>
                    </tr>
                </tbody>
            </table>
        </div>

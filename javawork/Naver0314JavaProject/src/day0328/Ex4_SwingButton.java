...
public class Ex4_SwingButton extends JFrame{
	...
	public void initDesign()
	{
		...
		this.add(btn1);
		//btn1 에 이벤트 추가 - 익명 내부클래스형태로 이벤트 구현
		...
		//버튼 2를 생성 후 프레임에 추가해주세염
		btn2=new JButton("not Hello!!");
		...
		for(int i=0;i<btnArray.length;i++)
		{
			...
			btnArray[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					switch(ob.getText())
					{
					case "빨강색"://부모 컴포넌트의 인스턴스 변수인 this를 통해서 배경색 변경
					...
					case"노랑색":
						...
						break;
					case"랜덤색":
						//0~255의 임의의 숫자 rgb를 구하 후 new color 생성자를 통해서 변경
					{

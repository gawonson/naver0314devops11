...
public class Ex10_DateNumberFormat {
	...
	public static void main(String[] args) {
		...
		System.out.println(sdf1.format(date));//2024-03-19 16:33:31 화
		
		SimpleDateFormat sdf2=new SimpleDateFormat("yyyy-MM-dd a HH:mm:ss EEEE");
		System.out.println(sdf2.format(date));//2024-03-19 오후 16:33:31 화요일

		SimpleDateFormat sdf3=new SimpleDateFormat("yyyy년 MM월 dd일 a HH시 mm분");
		System.out.println(sdf3.format(date));//2024년 03월 19일 오후 16시 34분
		
		//숫자 포맷양식 지정하기
		int money=5678900;
		double average=98.7656;
		
		NumberFormat nf1=NumberFormat.getCurrencyInstance();//화폐단위와 세자리마다 ,가 추가돼서 출력
		...
		System.out.println(nf2.format(average));//반올리 됨 :98.8

...
<body>
	<div style="margin: 20px ; width: 500px">
		<div class="input-group">
			...
			<button style="margin-left: 10px ; height: 50px" type="button" 
	...
	<%
			for(SawonDto dto:list){
				%>
				<div class="list">
					<img src='<%=dto.getPhoto().equals("no")?"../image/noimage2.png":dto.getPhoto()%>'>
					<br><%=dto.getName() %>사원
					<br>
					<button type="button" class="btn btn-sm btn-outline-danger" onclick="location.href='sawondetail.jsp?num=<%=dto.getNum()%>'">상세보기</button>
				</div>
				<%
			}
		%>

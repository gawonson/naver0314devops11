	...
	<table class="table table-bordered">
		...
		<tr>
			<td colspan="2" align="center">
				<button  class="btn btn-outline-secondary btn-sm" style="width: 80px">사원저장</button>
				<button  class="btn btn-outline-secondary btn-sm" style="width: 80px" onclick="location.href='sawonlist.jsp'">사원목록</button>
			</td>		
		</tr>
	</table>
</form>

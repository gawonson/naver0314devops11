		...
		<table class="table" style="width: 400px">
			...
			<tr>
				...
				<select class="form-select" name="foodphoto" id="foodphoto">
						<option value="../food/1.jpg,9000">샌드위치</option>
						<option value="../food/8.jpg,11000">샌드위치2</option>
						<option value="../food/11.jpg,13000">망고빙수</option>
						<option value="../food/10.jpg,8000">햄마요덮밥</option>
				</select> <img src="../food/1.jpg" id="photo" width="60" height="60"
			...
			<tr>
				...
				<td>
						<label><input type="radio" name="grade"value="매우만족" checked="checked">매우만족</label>
						<label><input type="radio" name="grade" value="만족">만족</label> 
						<label><input type="radio" name="grade" value="보통">보통</label> 
						<label><input type="radio" name="grade" value="불만">불만</label>
				</td>
			</tr>
			<tr>
				<th class="table-info" width="100">우수회원</th>
				<td><input type="checkbox" name="member">우수회원</td>
			</tr>
			<tr>

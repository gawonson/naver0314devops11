	...
	<form action="./ex8_action.jsp" method="post">
		<table class="table" style="width: 400px">
			...
			<tr>
				...
				<td><label><input type="checkbox" name="lic" >운전면혀</label></td>
			</tr>
			<tr>
				<th class="table-info" width="100">혈액형</th>
				<td>
					<select name="blood" class="form-select">
					<!-- value 와 label이 같을경우 value 생략 가능 -->
						<option>A</option>
			...
			<tr>
				<th class="table-info" width="100">가능한 아이티언어</th>
				<td>
					<select name="itlang" class="form-select" multiple="multiple" size="5">

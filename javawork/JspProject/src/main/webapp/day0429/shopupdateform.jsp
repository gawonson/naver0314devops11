...
<!-- hidden 서버전송시 각 상품에 대한 인덱스 값이 같이 보내져야한다 -->
	...
	<table class="table table-bordered">
		...
		<tr>
			<td colspan="2" align="center">
				<button type="submit" class="btn btn-secondary"  >DB에 수정</button>
				<button type="button" class="btn btn-secondary" onclick="history.back();">이전으로</button><!-- go(-1) 이나 back() 은 같다 -->
			</td>
		<tr>
	</table>
</form>

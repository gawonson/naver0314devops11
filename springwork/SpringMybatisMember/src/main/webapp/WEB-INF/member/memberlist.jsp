...
<body>
<h2 class="alert alert-warning" style="width: 500px">총${totalCount }명의 회원이 있습니다. 
...
<table class="table table-bordered" style="width: 500px">
	<tr>
		...
		<th class="table-warning">회원명</th>
		<th class="table-warning">아이디</th>
		<th class="table-warning">핸드폰</th>
		<th class="table-warning">상세보기</th>
	</tr>
	<c:forEach var="ele" items="${list }">
		<tr>
			<td>${ele.num }</td>
			<td>
				<img src="../image/${ele.photo }"  style="border: 1px solid black; border-radius: 30px; width: 30px ; height: 30px">
				${ele.name }
			</td>
			<td>${ele.myid }</td>
			<td>${ele.hp }</td>
